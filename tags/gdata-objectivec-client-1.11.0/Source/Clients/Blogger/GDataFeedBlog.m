...
#import "GDataFeedBlog.h"
#import "GDataEntryBlog.h"
#import "GDataBloggerConstants.h"


@implementation GDataFeedBlog

+ (GDataFeedBlog *)blogFeed {

  GDataFeedBlog *feed = [[[self alloc] init] autorelease];
