...
_EXTERN NSString* const kGDataWebmasterToolsFeedTypeSitemaps    _INITIALIZE_AS(@"sitemaps");
_EXTERN NSString* const kGDataWebmasterToolsFeedTypeKeywords    _INITIALIZE_AS(@"keywords");
_EXTERN NSString* const kGDataWebmasterToolsFeedTypeCrawlIssues _INITIALIZE_AS(@"crawlissues");
...
_EXTERN NSString* const kGDataGoogleWebmasterToolsMessagesFeed _INITIALIZE_AS(@"https://www.google.com/webmasters/tools/feeds/messages/");
